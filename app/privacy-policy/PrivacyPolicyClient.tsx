          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-3 max-w-2xl">
              ...
              <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
                Learn how the Finland–Vietnam Strategic Impact Initiative (FVSI) protects your privacy, manages internal authentication, and upholds European GDPR standards.
              </p>
            </div>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="text-sm md:text-base text-slate-600 leading-relaxed space-y-3">
              <p>
                The FVSI portal is engineered primarily for <strong>internal administrative, research partnership, and organizational coordination</strong> between the Faculty of ITEE at the University of Oulu and academic institutions in Vietnam.
              </p>
          ...
          >
            ...
            <div className="text-sm md:text-base text-slate-600 leading-relaxed space-y-2">
              ...
              <p>
                <strong>Retention Period:</strong> Personal identifiers associated with internal accounts are stored only for the duration of active institutional involvement in the FVSI collaboration or until account deletion is requested.
              </p>
            </div>
          </motion.section>
