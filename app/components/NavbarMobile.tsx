              ...
              <div className="border-t border-slate-100 py-2 px-2 bg-slate-50/50">
                {initialUser ? (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:text-red-600 hover:bg-slate-100 rounded-lg transition-colors cursor-pointer"
                  >
                  ...
                  <div className="flex flex-col gap-2 p-2">
                    ...
                    <Link
                      href="/sign-up"
                      onClick={closeMenu}
                      className="flex items-center justify-center gap-2 w-full px-4 py-2.5 text-sm font-bold text-slate-900 bg-[#00c2b2] rounded-lg shadow-[0_0_12px_rgba(0,194,178,0.35)] hover:shadow-[0_0_20px_rgba(0,194,178,0.5)] hover:bg-[#00b4a6] transition-all"
                    >
